...
class WatsonIBM:
    ...
    user_item_path = '../data/user-item-interactions.csv'
    doc_content_path = '../data/articles_community.csv'

    def upload_data(self):
        '''
        Function that uploads the two datasets and saves them
        ...
        # Import the datasets
        df = pd.read_csv(self.user_item_path, index_col=[0])
        df_content = pd.read_csv(self.doc_content_path, index_col=[0])
